class Order < ActiveRecord::Base
  ...
  has_many :programs, :through => :order_items

  validates_presence_of :order_items,
                        :message => 'Tu carrito de compra esa vacío! ' +
                                    'Por favor, añada al menos un programa antes de enviar la orden.'
  ...
  def active_merchant_payment
    ...
    # order information
    details = {
      :description      => 'Emporium Programstore purchase',
      :order_id         => self.id,
      :email            => email,
      :ip               => customer_ip,
